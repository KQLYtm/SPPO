    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new Profile { UserName = Input.Email, Email = Input.Email, PhoneNumber = Input.PhoneNumber, ProfilePicture= "e1fee577-d86f-4f2e-8793-305cb162fadb_blank-profile-picture-973460_640.png" };
                if (c.Id == 0)
                {
                    user.CompanyID = null;
                    user.UserID = u.Id;
